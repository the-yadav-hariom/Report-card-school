...
const Sidebar = () => {
  ...
  return (
    <aside className="no-print w-64 bg-sidebar text-gray-300 min-h-screen flex flex-col border-r border-sidebar-border shadow-xl">
      {/* Brand Header */}
      <div className="p-5 border-b border-sidebar-border bg-sidebar/80 backdrop-blur-sm">
        <Link to="/dashboard" className="flex items-center gap-3">
          ...
          />
          <div>
            <h1 className="font-heading text-lg font-bold text-white leading-tight tracking-wide">
              Stitch Academia
            </h1>
            <p className="text-[11px] text-gold-light font-medium tracking-tight flex items-center gap-1">
      ...
      {/* Admin Profile Card */}
      <div className="mx-4 my-4 p-3 rounded-lg bg-sidebar-hover/60 border border-sidebar-border/50 flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-maroon text-white font-bold flex items-center justify-center text-xs shadow-inner">
      ...
      {/* Session Badge & Quick Link */}
      <div className="p-4 border-t border-sidebar-border bg-sidebar/50 text-xs">
        <div className="bg-maroon-dark/40 border border-maroon/40 rounded-lg p-2.5 mb-3 text-center">
